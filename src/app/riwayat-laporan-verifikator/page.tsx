      ...
      <main className="flex-1 px-6 py-6">
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-6 gap-4 animate-fadeInUp">
              <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-2 sm:space-y-0 sm:space-x-4 w-full lg:w-auto">
                ...
                <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
                  ...
                  <select
                    ...
                    className="px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#0B7A95] bg-white text-black min-w-[140px]"
                  >
          ...
          <div className="bg-[#A8C8D8] rounded-lg max-w-md w-full max-h-[90vh] overflow-y-auto relative">
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="text-xs text-gray-600 space-y-1 px-2 pb-2 mt-2">
                ...
                <p>
                  <span className="font-semibold">Revisi:</span> Minta perbaikan
                  laporan dengan mengubah kategori, grading, atau kronologi.
                </p>
                <p>
                  <span className="font-semibold">Riwayat:</span> Lihat riwayat
                  perubahan dan catatan pada laporan ini.
                </p>
              </div>
            </div>
          </div>
