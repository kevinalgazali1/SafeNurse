...
export default function DashboardChiefNursing() {
  ...
  useEffect(() => {
    ...
    style.textContent = `
      ...
      .animate-fadeInDelayed { animation: fadeInDelayed 1s ease-out 0.3s both; }
      .animate-fadeInDelayed2 { animation: fadeInDelayed2 1s ease-out 0.6s both; }
      ...
      <main className="flex-1 px-6 py-6 animate-slideDown">
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <div className="hidden lg:block bg-white rounded-lg overflow-hidden shadow-lg animate-glow animate-tableSlideUp">
              {/* Table Header */}
            ...
            <div className="lg:hidden space-y-4 animate-fadeInDelayed">
              {reports.map((report, index) => (
                <div key={report.id} className={`animate-fadeInUp stagger-${Math.min(index + 1, 4)}`}>
                  <MobileReportCard
                    report={report}
