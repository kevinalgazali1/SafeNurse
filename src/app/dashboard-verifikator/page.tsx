  ...
  const handleExportExcel = () => {
    const ws = XLSX.utils.json_to_sheet(
      laporanData.map((item, index) => ({
        ...
        Catatan_Chief_Nursing: item.catatan_chief_nursing,
        Catatan_Verifikator: item.catatan_verifikator,
        Kategori_Kepala_Ruangan: item.kategori_kepala_ruangan,
        Kategori_Chief_Nursing: item.kategori_chief_nursing,
        Kategori_Verifikator: item.kategori_verifikator,
        Grading_Kepala_Ruangan: item.grading_kepala_ruangan,
        Grading_Chief_Nursing: item.grading_chief_nursing,
        Grading_Verifikator: item.grading_verifikator,
        Kronologi_Kepala_Ruangan: item.kronologi_kepala_ruangan,
        Kronologi_Chief_Nursing: item.kronologi_chief_nursing,
        Kronologi_Verifikator: item.kronologi_verifikator,
        Implementasi_Kepala_Ruangan: item.implementasi_kepala_ruangan,
        Implementasi_Chief_Nursing: item.implementasi_chief_nursing,
        Implementasi_Verifikator: item.implementasi_verifikator,
        Hasil_Kepala_Ruangan: item.hasil_kepala_ruangan,
        Hasil_Chief_Nursing: item.hasil_chief_nursing,
        Hasil_Verifikator: item.hasil_verifikator,
        Rencana_Tindak_Lanjut_Chief_Nursing: item.rencana_tindak_lanjut_chief_nursing,
        Rencana_Tindak_Lanjut_Kepala_Ruangan: item.rencana_tindak_lanjut_kepala_ruangan,
        Rencana_Tindak_Lanjut_Verifikator: item.rencana_tindak_lanjut_verifikator,
              ...
              <div className="flex justify-between items-center">
                ...
                <div className="hidden md:flex items-center space-x-6">
                  ...
                  <button
                    className="flex flex-col items-center text-white hover:text-[#0B7A95] transition-colors"
                    onClick={() =>
                      (window.location.href = "/video-tutorial-verifikator")
                    }
                  >
