                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                      ...
                      <div className="relative">
                        <input
                          ...
                          className="w-full sm:w-80 px-4 py-2 pl-10 pr-4 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#0B7A95] focus:border-transparent bg-white text-black placeholder-gray-500"
                        />
